...
namespace ITRoots.Models
{
    ...
    public partial class db_a79052_rootdbEntities : DbContext
    {
        ...
        public virtual int SaveUser(Nullable<int> iD, string fullName, string username, string password, string email, string phoneNumber, Nullable<bool> isEmailConfirmed, Nullable<bool> isAdd)
        {
            var iDParameter = iD.HasValue ?
                new ObjectParameter("ID", iD) :
                new ObjectParameter("ID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SaveUser", iDParameter, fullNameParameter, usernameParameter, passwordParameter, emailParameter, phoneNumberParameter, isEmailConfirmedParameter, isAddParameter);
        }
